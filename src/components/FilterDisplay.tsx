...
function FilterDisplay() {
  ...
  useLayoutEffect(() => {
    ...
    //Sliders:
    let regionSlider: HTMLInputElement = (document.getElementById(
      "regionCheck"
    ) as HTMLInputElement)!;
    let popSlider: HTMLInputElement = (document.getElementById(
      "popCheck"
    ) as HTMLInputElement)!;
    let areaSlider: HTMLInputElement = (document.getElementById(
      "areaCheck"
    ) as HTMLInputElement)!;
    ...
    //Area & population:
    let areaInput: HTMLInputElement = (document.getElementById(
      "areaInput"
    ) as HTMLInputElement)!;
    let popInput: HTMLInputElement = (document.getElementById(
      "popInput"
    ) as HTMLInputElement)!;
    areaInput.value =
      filterState.area > 0 ? JSON.stringify(filterState.area) : "";
    popInput.value = filterState.pop > 0 ? JSON.stringify(filterState.pop) : "";

    //Greater than-fields:
    let areaSelector: HTMLSelectElement = (document.getElementById(
      "areaGreater"
    ) as HTMLSelectElement)!;
    let popSelector: HTMLSelectElement = (document.getElementById(
      "popGreater"
    ) as HTMLSelectElement)!;
